...
Configuration (example):
    ...
    # Whether or not to include public keys of known clients in the known_hosts file
    # that is served to other clients. Can be true/false. If true, the known_hosts
    # endpoint will list public keys for all known client hosts. If false, it will only
    # include the extra_known_hosts entries.
    client_known_hosts: true
